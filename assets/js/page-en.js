...
function waktu() {
	...
	var namaHari = ["Sunday", "Monday", "Thursday", "Webnesday", "Tuesday", "Friday", "Saturday"];
...
$('.test-jaringan').click(function() {
	...
	$('.test-jaringan').html('Please Wait');
...
function displaySpeed() {
	...
	$('.test-jaringan').html('<i class="fas fa-cogs"></i> CHEKC AGAIN');
}
